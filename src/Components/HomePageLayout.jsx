     ...
     {  
        ...
        <div className="w-[100vw] max-h-[100vh] ">
                                  ...
                                  <div className="w-[100%] h-[60px] bg-black  flex  items-center gap-3 text-white">
                                 
                                        {
                                          social_Media_contacts.map((item,index)=>(
                                            <Link  key={index} className=" w-[30px] h-[30px] border rounded-full hover:bg-white hover:text-black hover:scale-125 duration-200 flex items-center justify-center gap-2">
                                              {item.icon}
              ...
              <div className="w-[100vw] h-[40px] flex items-center justify-center bg-black text-white border-t border-white font-ubuntu text-sm">
                        <a href="" className="flex text-xs items-center  justify-center"> <FaCopyright className="text-lg"/> CopyRights Reserved <span className="ml-1 text-mainColor"> Food Corner</span><span className="ml-1"> || Bulid by <span className="text-md text-yellow-500">Umar farooq</span></span></a>
                     </div>
